    ...
    if request.method == 'POST':
        ...
        if form.validate() == True:
            ...
            ytdl_format_options = {'format': 'bestaudio/best',
                                       'outtmpl':'/google/google-cloud-sdk/platform/gsutil/gslib/tests/test_data/' + 'song'+ file_num + '.mp3',
                                       'quiet': True}
            with youtube_dl.YoutubeDL(ytdl_format_options) as ytdl:
                ...
                return send_file(filename_or_fp='/google/google-cloud-sdk/platform/gsutil/gslib/tests/test_data/' + 'song'+ file_num + '.mp3',
